...
| **임원석** | <br><br><br> |
| **조민규** | <br><br><br> |
| **최현지** | 삭제 UX 개선 작업을 하면서, 작은 기능이라도 사용자 입장에서 고민하는 과정이 얼마나 중요한지 깨달았습니다. 또 프로젝트 문서화를 맡아 진행하면서 협업에서 README의 역할이 얼마나 큰지도 실감하게 되었습니다. 이번 프로젝트를 통해 기능 구현뿐 아니라 사용성·문서 정리·팀 협업 구조까지 함께 생각하는 개발자로 성장하고 싶다는 목표가 생겼습니다.|
...
| **최현지** | deleteBook UX 기능 개선(미리보기·Double Check), README 프로젝트 문서 관리 |
